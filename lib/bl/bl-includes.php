...
require_once( BL_PLUGIN_DIR . 'lib/bl/bl-functions.php' );
...
if( is_admin() ) {
    ...
    // Fancy var_dump
    require_once( BL_PLUGIN_DIR . 'lib/bl/dBug.php' );

    /*
    * Local extension to debug bar
    */
    require_once( BL_PLUGIN_DIR . 'lib/bl/BLDebugBar.class.php' );
}
...
*/
require_once( BL_PLUGIN_DIR . 'lib/functions.php' );